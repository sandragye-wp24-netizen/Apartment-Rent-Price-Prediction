...
# ============================================================
    ...
    st.caption(
        "The table displays the first 10 records from the "
        "prepared apartment rental dataset."
    )
    ...
    st.write(
        """
        This distribution shows the frequency of apartment
        listings across different rental price ranges. It helps
        identify the most common rental-price levels and the
        overall spread of rental prices.
        """
    )
    ...
    st.write(
        """
        The chart compares average rental prices for apartments
        with different numbers of bedrooms. It helps determine
        whether apartments with more bedrooms generally have
    ...
    # Use a sample to keep Streamlit responsive
    ...
    st.write(
        ...
        apartment size and rental price. Larger apartments
        may generally have higher rental prices, although
        other variables such as location and facilities also
    ...
    # Avoid misleading states with very few observations
    ...
    st.write(
        ...
        geographical location is an important factor in
    ...
    st.write(
        ...
        to 1 indicate a stronger positive linear relationship,
        while values closer to -1 indicate a stronger negative
        relationship.
        """
    )
...
# ============================================================
    ...
    st.write(
        """
        RMSE gives greater penalties to larger prediction
        errors. Lower RMSE indicates better predictive
        performance.
    ...
    st.write(
        ...
        **Random Forest achieved the highest Testing R² of
        ...
        variation in rental prices was explained by the model.**
        """
    )
    ...
    st.write(
        """
        Comparing training and testing performance helps
        identify possible overfitting. Random Forest shows
        some difference between training and testing MAE,
        but it still provides the strongest testing
    ...
    st.subheader("Model Selection Conclusion")
    ...
    st.info(
        ...
        model must make predictions for new and unseen apartment
        listings.
        """
    )
...
# ============================================================
    ...
    st.subheader("Deployed Model Performance Check")
    ...
    st.caption(
        ...
        Forest model currently loaded by the Streamlit
        application.
        """
    )
    ...
    st.write(
        """
        Each point represents an apartment listing. The
        diagonal reference line represents perfect predictions.

        Predictions closer to the diagonal line indicate
        smaller prediction errors, while points further away
        indicate larger differences between actual and
        predicted rental prices.
        """
    )
    ...
    try:
        ...
        st.write(
            """
            Feature importance indicates how strongly each
            predictor contributes to the Random Forest
            predictions.

            Features with higher importance values have a
            greater influence on the model's prediction.
            """
        )
        ...
        st.warning(
            """
            Feature importance could not be displayed for the

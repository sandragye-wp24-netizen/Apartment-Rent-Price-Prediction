...
# ============================================================
    ...
    st.info(
        ...
        **CSV Input Format**
        ...
        For `state`, use the same state abbreviation format
        as the prepared dataset, for example:
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            st.write(
                f"Detected file encoding: **{detected_encoding}**"
            )
            ...
            # =================================================
                ...
                if extra_columns:
                    ...
                    st.info(
                        ...
                        in the output file but will not be used by
                ...
                if invalid_state_records > 0:
                    ...
                    st.warning(
                        ...
                        match the state values used in the prepared
                        dataset. These rows will not be predicted.
                        """
                    )
                ...
                if (
                    ...
                    st.success(
                        """
                        All uploaded rows passed the required
                        data-quality checks.
                        """
                    )
